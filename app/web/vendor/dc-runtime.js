...
(() => {
  ...
  function isSvgTextCtx(node) {/*MINERVA-SVG-TEXT-FIX*/
  ...
  function walkText(node) {
    ...
    const svgCtx = isSvgTextCtx(node);/*MINERVA-SVG-TEXT-FIX*/
    ...
    return (vals, ctx, key) => h(
      ...
      ...parts.map((p, i) => {
        ...
        return svgCtx ? String(v) : h("span", { key: i, className: "sc-interp" }, String(v));/*MINERVA-SVG-TEXT-FIX*/
      })
    );
  }
